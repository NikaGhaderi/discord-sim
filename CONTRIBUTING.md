...
- [ ] Implementation follows Clean Architecture as defined in `.cursorrules`.
...
- Review for architecture compliance first, correctness second, style last (style is automated).
- Reviewers should leave actionable comments. If approving with reservations, say so explicitly.
